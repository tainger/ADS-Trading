...
def get_database() -> BaseDatabase:
    ...
    if database_name == 'mysql':
        from ads_trading.trader.dbconnectors import MysqlDatabase as Database

    elif database_name == 'sqlite':
        from ads_trading.trader.dbconnectors import SqliteDatabase as Database

    elif database_name == 'mongo':
        from ads_trading.trader.dbconnectors import MongodbDatabase as Database
